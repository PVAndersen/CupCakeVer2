...
public class ControlServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user == null || whoareyou != null) {
                ...
                case "login":
                    ...
                    if (user == null) {
                        ...
                        RequestDispatcher rd = request.getRequestDispatcher("useron.jsp");
        ...
        if ("addtocart".equals(addToCart)) {
            ...
            FindCake findCake = new FindCake();
            CakeTopping cakeTopping = findCake.findCakeTopping(topping, topList);
            CakeBottom cakeBottom = findCake.findCakeBottom(bottom, botList);
            CupCake cupCake = new CupCake(cakeTopping, cakeBottom);
            OrderLine orderLine = new OrderLine(cupCake, quantity);
            findCake.addToCart(cartList, orderLine);
            RequestDispatcher rd = request.getRequestDispatcher("useron.jsp");
            rd.forward(request, response);
        }
        ...
        if (removeFromCart != null) {
            FindCake findCake = new FindCake();
            findCake.removeOrderLine(cartList, removeFromCart);
